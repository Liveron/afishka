...
const convertToBase64 = function (url, imagetype, callback) {
...
const sendBase64ToServer = function (name, base64) {
    ...
    // Set the content type of the request to json since that what being sent
...
const uploadImage = function (src, name, type) {
